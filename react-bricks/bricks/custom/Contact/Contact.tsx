...
import { Text, File } from 'react-bricks/frontend'
...
const Contact: types.Brick<IContactProps> = () => {
  ...
  return (
    <div className="w-full mt-[140px] mb-[116px]">
      <div className="max-w-screen-container mx-auto w-full h-[450px] bg-[#D8D8D8] mb-10"></div>
      <div className="px-4 container:px-0 max-w-screen-container mx-auto grid grid-cols-1 lg:grid-cols-3 gap-x-8">
        <div className="max-w-screen-sm lg:col-span-2">
          <h1 className="w-full font-open-sans font-normal text-[#2B2B2B] text-3xl mb-[24px]">
            Reach Out
          </h1>
          <div className="w-full flex justify-between mb-[16px]">
            <Input
              value={contact.name}
              placeholder="Name"
              className="grow"
        ...
        <div className="flex flex-col gap-y-[24px] w-[466px]">
