  ...
  return (
    <div className="mb-10">
      <div className="flex flex-col">
        ...
        <div className="max-w-screen-container px-4 container:px-0 mx-auto mt-[80px]">
          <div className="grid grid-cols-5 md:grid-cols-7 gap-8">
                ...
                <div className="flex flex-col border-[1px] px-[86px] py-[60px] rounded-[20px]">
                  ...
                  <div className="flex flex-col items-center justify-center text-center text-[#000000] font-medium">
                    ...
                    <div className="flex flex-col items-center justify-center">
                      <Image alt="Combo2" src={Combo3} className="absolute" />
                      <p className="text-[#575757] text-[13px]">
                        Polina Podolski
                      </p>
                      <p className="text-[#F37335] text-[12px] italic">
                        Mother
                      </p>
                    </div>
                  </div>
